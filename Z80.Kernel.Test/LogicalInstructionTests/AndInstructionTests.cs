...
namespace Z80.Kernel.Test.LogicalInstructionTests
{
    ...
    public class AndInstructionTests
    {
        ...
        public void AndIXH()
        {
            var assembler = new Z80Assembler.Z80Assembler(new List<string> { "ORG $3000", "AND IXH" });
            bool result = assembler.BuildProgram();
            Assert.AreEqual(result, true);
            Assert.AreEqual(assembler.AssembledProgramBytes.Length, 2);
            Assert.AreEqual(assembler.AssembledProgramBytes[0], 0xDD);
        ...
        public void AndIXL()
        {
            var assembler = new Z80Assembler.Z80Assembler(new List<string> { "ORG $3000", "AND IXL" });
            bool result = assembler.BuildProgram();
            Assert.AreEqual(result, true);
            Assert.AreEqual(assembler.AssembledProgramBytes.Length, 2);
            Assert.AreEqual(assembler.AssembledProgramBytes[0], 0xDD);
        ...
        public void AndIYH()
        {
            var assembler = new Z80Assembler.Z80Assembler(new List<string> { "ORG $3000", "AND IYH" });
            bool result = assembler.BuildProgram();
            Assert.AreEqual(result, true);
            Assert.AreEqual(assembler.AssembledProgramBytes.Length, 2);
            Assert.AreEqual(assembler.AssembledProgramBytes[0], 0xFD);
        ...
        public void AndIYL()
        {
            var assembler = new Z80Assembler.Z80Assembler(new List<string> { "ORG $3000", "AND IYL" });
            bool result = assembler.BuildProgram();
            Assert.AreEqual(result, true);
            Assert.AreEqual(assembler.AssembledProgramBytes.Length, 2);
            Assert.AreEqual(assembler.AssembledProgramBytes[0], 0xFD);
