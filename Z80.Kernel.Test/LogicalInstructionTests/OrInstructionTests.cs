...
namespace Z80.Kernel.Test.LogicalInstructionTests
{
    ...
    public class OrInstructionTests
    {
        ...
        public void OrIXH()
        {
            var assembler = new Z80Assembler.Z80Assembler(new List<string> { "ORG $3000", "OR IXH" });
            bool result = assembler.BuildProgram();
            Assert.AreEqual(result, true);
            Assert.AreEqual(assembler.AssembledProgramBytes.Length, 2);
            Assert.AreEqual(assembler.AssembledProgramBytes[0], 0xDD);
        ...
        public void OrIXL()
        {
            var assembler = new Z80Assembler.Z80Assembler(new List<string> { "ORG $3000", "OR IXL" });
            bool result = assembler.BuildProgram();
            Assert.AreEqual(result, true);
            Assert.AreEqual(assembler.AssembledProgramBytes.Length, 2);
            Assert.AreEqual(assembler.AssembledProgramBytes[0], 0xDD);
        ...
        public void OrIYH()
        {
            var assembler = new Z80Assembler.Z80Assembler(new List<string> { "ORG $3000", "OR IYH" });
            bool result = assembler.BuildProgram();
            Assert.AreEqual(result, true);
            Assert.AreEqual(assembler.AssembledProgramBytes.Length, 2);
            Assert.AreEqual(assembler.AssembledProgramBytes[0], 0xFD);
        ...
        public void OrIYL()
        {
            var assembler = new Z80Assembler.Z80Assembler(new List<string> { "ORG $3000", "OR IYL" });
            bool result = assembler.BuildProgram();
            Assert.AreEqual(result, true);
            Assert.AreEqual(assembler.AssembledProgramBytes.Length, 2);
            Assert.AreEqual(assembler.AssembledProgramBytes[0], 0xFD);
