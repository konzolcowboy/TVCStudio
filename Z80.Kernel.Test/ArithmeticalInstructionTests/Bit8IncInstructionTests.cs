...
namespace Z80.Kernel.Test.ArithmeticalInstructionTests
{
    ...
    public class Bit8IncInstructionTests
    {
        ...
        public void IncIXH()
        {
            var assembler = new Z80Assembler.Z80Assembler(new List<string> { "ORG $3000", "INC IXH" });
            bool result = assembler.BuildProgram();
            Assert.AreEqual(result, true);
        ...
        public void IncIXL()
        {
            var assembler = new Z80Assembler.Z80Assembler(new List<string> { "ORG $3000", "INC IXL" });
            bool result = assembler.BuildProgram();
            Assert.AreEqual(result, true);
            Assert.AreEqual(assembler.AssembledProgramBytes.Length, 2);
            Assert.AreEqual(assembler.AssembledProgramBytes[0], 0xDD);
        ...
        public void IncIYH()
        {
            var assembler = new Z80Assembler.Z80Assembler(new List<string> { "ORG $3000", "INC IYH" });
            bool result = assembler.BuildProgram();
            Assert.AreEqual(result, true);
            Assert.AreEqual(assembler.AssembledProgramBytes.Length, 2);
            Assert.AreEqual(assembler.AssembledProgramBytes[0], 0xFD);
        ...
        public void IncIYL()
        {
            var assembler = new Z80Assembler.Z80Assembler(new List<string> { "ORG $3000", "INC IYL" });
            bool result = assembler.BuildProgram();
            Assert.AreEqual(result, true);
            Assert.AreEqual(assembler.AssembledProgramBytes.Length, 2);
            Assert.AreEqual(assembler.AssembledProgramBytes[0], 0xFD);
